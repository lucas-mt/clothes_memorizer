...
def cria_arm_ano():
    if not os.path.exists(f'/Users/Cliente/OneDrive/Documentos/VITRINE online/armazenamento_{agora.tm_year}/'):
        os.mkdir(f'/Users/Cliente/OneDrive/Documentos/VITRINE online/armazenamento_{agora.tm_year}/')
